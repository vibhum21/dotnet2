<%@ Page Language="VB" MasterPageFile="~/AdWorksPage.master" AutoEventWireup="false" CodeFile="HR.aspx.vb" Inherits="HR" title="Untitled Page" %>
...
<asp:Content ID="PageContentPlaceHolder" ContentPlaceHolderID="PageContentPlaceHolder"
    runat="server">
    Welcome<br />
    This is the Adventure Works HR page.
</asp:Content>
