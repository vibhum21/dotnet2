...
<html>
	...
	<body>
		...
		<form runat="server">
			...
			<p>
				<asp:Button id="button1" text="Call Page.DataBind()"
                     onClick="PageDataBind" runat="server" />
				<asp:Button id="button2" text="Call Bind DropDown1 to new data()" 
                    onClick="DropDown1DataBind" runat="server" />
				<asp:Button id="button3" text="Do Nothing" onClick="DoNothing" 
                    runat="server" />
