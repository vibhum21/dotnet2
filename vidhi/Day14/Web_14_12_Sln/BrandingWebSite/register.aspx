<%@ Page Title="" Language="C#" MasterPageFile="~/site.master"
     ...
     EnableTheming="true" Theme="Corporate" %>
    ...
    <table class="auto-style1">
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                     ...
                     ErrorMessage="Please  add first Name">
        ...
        <tr>
            ...
            <td class="auto-style6">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2"
                    ...
                    ErrorMessage="Please Add LastName">
                </asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txtAge" ErrorMessage="Customer age should be in between 18 to 60" MaximumValue="60" MinimumValue="18" Type="Integer"></asp:RangeValidator>
            </td>
        </tr>
        <tr>
            <td class="auto-style4">
