...
namespace LinqToXmlDataBinding {
    public partial class Window1 : Window {
        ...
        private void OnMouseUp(object sender, System.Windows.Input.MouseButtonEventArgs e) {
            ...
            switch (content) {
                case "Most Viewed":
                    objectDataProvider.MethodParameters[0] = @"http://blogs.msdn.com/b/ericlippert/rss.aspx?listId=MostPopular";
                    objectDataProvider.Refresh();
                    break;
                case "Most Recent":
                    objectDataProvider.MethodParameters[0] = @"http://blogs.msdn.com/b/ericlippert/rss.aspx?listId=MostRecent";
                    objectDataProvider.Refresh();
                    break;
                case "Top Favorites":
                    objectDataProvider.MethodParameters[0] = @"http://blogs.msdn.com/b/ericlippert/rss.aspx?listId=TopFavorites";
                    objectDataProvider.Refresh();
                    break;
                case "Top Rated":
                    objectDataProvider.MethodParameters[0] = @"http://blogs.msdn.com/b/ericlippert/rss.aspx?listId=TopRated";
                    objectDataProvider.Refresh();
                    break;
                case "My Favorites":
